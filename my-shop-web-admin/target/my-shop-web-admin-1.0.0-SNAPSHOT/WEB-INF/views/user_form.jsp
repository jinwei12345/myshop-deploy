...
<%--                                        <input type="text" class="form-control" id="inputUsername" name="username" placeholder="请输入用户的姓名">--%>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <form:input path="phone" cssClass="form-control mobile required"  placeholder="请输入用户的手机号"/>
<%--                                        <input type="text" class="form-control" id="inputPhone" name="phone" placeholder="请输入用户的手机号">--%>
                                    </div>
                                </div>

                            </div>
<%--                            <form:form action="" method="post" modelAttribute="tbTest">--%>
<%--                                <form:input path="testName" placeholder ="hh"/>--%>
