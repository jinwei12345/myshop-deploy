...
<%--                           <input type="checkbox" class="minimal" id="testdsdf" /> --%>
                        </div>
                        <!-- /.box-header -->
        ...
        var _columns= [
            ...
            {"data" : function (row,type,val,meta) {
                    ...
                    return '<button type="button" class="btn btn-sm  btn-default" onclick="App.showDetail(\''+detailUrl+'\')"><i class="fa fa-search"> </i> 查看</button>&nbsp;&nbsp;'+
                        ...
                        '<a href="#" type="button" class="btn btn-sm  btn-danger" onclick="App.deleteMulti(\'/user/delete\')"><i class="fa fa-trash-o" ></i> 删除</a>&nbsp;&nbsp;';
