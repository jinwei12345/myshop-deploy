    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p id="modal-detail-body">

                </p>
            </div>
            <div class="modal-footer">
                <button  type="button" class="btn btn-primary" onclick=window.location.reload() data-dismiss="modal" >确定</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
...
<script src="/static/assets/plugins/jquery-validation/dist/additional-methods.min.js"></script>
<script src="/static/assets/plugins/jquery-validation/dist/localization/messages_zh.min.js"></script>
<!-- iCheck 1.0.1 -->
